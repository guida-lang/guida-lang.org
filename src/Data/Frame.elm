...
ceiling zone frame =
    case frame of
        Days14 ->
            Data.Time.ceilingDay zone 1

        Days7 ->
            Data.Time.ceilingHour zone 12

        Days2 ->
            Data.Time.ceilingHour zone 2

        Hours24 ->
            Data.Time.ceilingHour zone 1

        Hours12 ->
            Data.Time.ceilingMinute zone 30
...
floor zone frame =
    case frame of
        Days14 ->
            Data.Time.floorDay zone 1

        Days7 ->
            Data.Time.floorHour zone 12

        Days2 ->
            Data.Time.floorHour zone 2

        Hours24 ->
            Data.Time.floorHour zone 1

        Hours12 ->
            Data.Time.floorMinute zone 30
